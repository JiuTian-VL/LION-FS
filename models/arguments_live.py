...
class LiveTrainingArguments(TrainingArguments):
    ...
    llm_pretrained: str = '/your/path/to/llm/model' 
    vision_pretrained: str = 'your/pretrained/vision/siglip-model'
    vision_pretrained_ego: str = 'your/pretrained/vision/egovlp'
    lora_modules: str = "model.*(q_proj|k_proj|v_proj|o_proj|gate_proj|up_proj|down_proj)|lm_head$"
    lora_r: int = 128
    lora_alpha: int = 256
    finetune_modules: list[str] = field(default_factory=lambda: ['connector','connector1','router1','router'])
